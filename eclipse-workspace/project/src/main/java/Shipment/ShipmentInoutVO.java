...
public class ShipmentInoutVO {
    ...
    private ArrayList<ShipmentLineVO> lineItems = new ArrayList<>();
    ...
    public List<ShipmentLineVO> getLineItems() {
        return lineItems;
    }

    public void setLineItems(ArrayList<ShipmentLineVO> lineItems) {
