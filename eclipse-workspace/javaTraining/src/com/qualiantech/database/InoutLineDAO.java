...
//	}
	...
	public InoutLineDAO(String createdby,String updatedby,String inoutId, String productId, int quantity) {
		this.createdby = createdby;
		this.updatedby = updatedby;
		this.inoutId = inoutId;
		this.productId = productId;
...
//	public InoutLineDAO(String name,String productId, int quantity) {
//		this.createdby=name;
//		this.updatedby=name;
//		this.productId=productId;
//		this.quantity=quantity;
